...
# CUDA_VISIBLE_DEVICES=0 python create_kitti_submission_tile.py
...
if __name__ == '__main__':
    ...
    checkpoints_path = 'checkpoints_kitti/raft-kitti.pth'
    if checkpoints_path is not None:
        model.load_state_dict(torch.load(checkpoints_path), strict=True)
    model.cuda()
    model.eval()

    evaluate_tile.create_kitti_submission(model.module)
